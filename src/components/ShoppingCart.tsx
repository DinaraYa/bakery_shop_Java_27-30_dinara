...
const ShoppingCart = () => {
    ...
    const getTableShopCartProduct = (prod: ShopCartProdType) => {
        ...
        let res:TableShopCartDataType = {id: undefined, amount: 0, category: "", cost: 0, count: 0, image: "", title: "", unit: ""}
        if (!product)
    ...
    const rows = cartProducts.map((prod: ShopCartProdType) => getTableShopCartProduct(prod))
